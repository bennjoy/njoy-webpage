...
<main class="bg-[#1E1E1E] min-h-screen pt-20">
  ...
  <section style="position: relative; height: 400px; background-image: url('/naburn-and-welby.jpg'); background-size: cover; background-position: center;">
    ...
    <div style="position: absolute; bottom: 40px; left: 40px; color: white;">
      <h1 style="font-size: 3rem; font-weight: 700; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.5);">Naburn & Welby</h1>
    </div>
  </section>
  `}
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div style="background-color: rgb(43, 43, 43);" class="rounded-lg p-6 sticky top-24">
            ...
            <div class="space-y-3">
              <div class="flex justify-between items-center">
                ...
                <span class="text-njoy-green font-semibold">£{roomPricing['House'][contractLength]}</span>
              </div>
            </div>
        ...
        <div class="lg:col-span-3">
          <div style="background-color: rgb(43, 43, 43);" class="rounded-lg p-6 mb-8">
            <h2 class="text-white font-bold text-2xl mb-4">About Naburn & Welby</h2>
            <p class="text-gray-300 mb-4">
              Naburn & Welby offers traditional student house living in a friendly, community-focused environment. Our houses provide an authentic student experience with shared living spaces that foster lasting friendships.
            </p>
            <p class="text-gray-300">
              Located in a residential area with excellent transport links to Manchester's universities, our houses combine the comfort of home with the independence of student life.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 gap-6">
            ...
            <!-- House Card -->
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden max-w-md">
              <div class="relative">
                <img src="/naburn-and-welby.jpg" alt="House" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
                  £{roomPricing['House'][contractLength]} per week
                </div>
              </div>
              <div class="p-4">
                <h3 class="text-white font-bold text-lg mb-2">House</h3>
                <p class="text-gray-300 text-sm mb-4">Shared house accommodation with communal living areas and kitchen</p>
...
{#if showBookingModal}
  <BookingModal siteName="Naburn & Welby" roomType={selectedRoom} bind:isOpen={showBookingModal} />
{/if}
