<script>
  ...
  // All rooms data for Carfax Court
  const allRooms = [
    { type: 'Double Ensuite', price51: 165, price45: 179, description: 'Double bedroom with luxurious en-suite bathroom' },
    { type: 'Studio', price51: 189, price45: 205, description: 'Modern studio apartment with kitchenette' },
    { type: 'One Bed Flat', price51: 225, price45: 244, description: 'Spacious one bedroom flat with full facilities' }
  ];

  const roomTypes = ['Double Ensuite', 'Studio', 'One Bed Flat'];
  ...
  const subLocations = ['Carfax Court'];
...
<svelte:head>
  <title>Carfax Court - All Rooms | Njoy Student Living</title>
  <meta name="description" content="Browse all available rooms at Carfax Court with flexible filtering options" />
</svelte:head>
...
<main class="bg-[#1E1E1E] min-h-screen pt-20">
  ...
  <section style="position: relative; height: 400px; background-image: url('/carfax-court.jpg'); background-size: cover; background-position: center;">
    ...
    <div style="position: absolute; bottom: 40px; left: 40px; color: white;">
      <h1 style="font-size: 3rem; font-weight: 700; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.5);">Carfax Court - All Rooms</h1>
    </div>
  </section>
  `}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {#each filteredRooms as room (room.type)}
                <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
                  <div class="relative">
                    <img src="/carfax-court.jpg" alt={room.type} class="w-full h-48 object-cover">
                  ...
                  <div class="p-4">
                    ...
                    <div class="flex gap-2">
                      ...
                      <a 
                        href="/locations/manchester/carfax-court"
