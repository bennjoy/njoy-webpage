<script>
  ...
  const roomPricing = {
    'Double Ensuite': { '51wks': 165, '45wks': 179 },
    'Studio': { '51wks': 189, '45wks': 205 },
    'One Bed Flat': { '51wks': 225, '45wks': 244 }
  };
...
<main class="bg-[#1E1E1E] min-h-screen pt-20">
  ...
  {@html `
  <section style="position: relative; height: 400px; background-image: url('/carfax-court.jpg'); background-size: cover; background-position: center;">
    <!-- Dark overlay -->
    ...
    <div style="position: absolute; bottom: 40px; left: 40px; color: white;">
      <h1 style="font-size: 3rem; font-weight: 700; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.5);">Carfax Court</h1>
    </div>
  </section>
  `}
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div style="background-color: rgb(43, 43, 43);" class="rounded-lg p-6 sticky top-24">
            ...
            <div class="space-y-3">
              <div class="flex justify-between items-center">
                <span class="text-gray-300">Double Ensuite</span>
                <span class="text-njoy-green font-semibold">£{roomPricing['Double Ensuite'][contractLength]}</span>
              </div>
              <div class="flex justify-between items-center">
              ...
              <div class="flex justify-between items-center">
                <span class="text-gray-300">One Bed Flat</span>
                <span class="text-njoy-green font-semibold">£{roomPricing['One Bed Flat'][contractLength]}</span>
              </div>
            </div>
        ...
        <div class="lg:col-span-3">
          <div style="background-color: rgb(43, 43, 43);" class="rounded-lg p-6 mb-8">
            <h2 class="text-white font-bold text-2xl mb-4">About Carfax Court</h2>
            <p class="text-gray-300 mb-4">
              Carfax Court represents the pinnacle of student accommodation in Manchester city centre. With premium finishes and modern amenities, our residents enjoy luxury living just minutes from the university campus.
            </p>
            <p class="text-gray-300">
              Featuring state-of-the-art facilities, secure access, and a prime location, Carfax Court provides an exceptional student living experience in the heart of one of the UK's most vibrant cities.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/carfax-court.jpg" alt="Double Ensuite" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
                  £{roomPricing['Double Ensuite'][contractLength]} per week
                </div>
              </div>
              <div class="p-4">
                <h3 class="text-white font-bold text-lg mb-2">Double Ensuite</h3>
                <p class="text-gray-300 text-sm mb-4">Spacious double room with private ensuite and shared kitchen</p>
                <div class="flex gap-2">
                  <button 
                    on:click={() => openBookingModal('Double Ensuite')}
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/carfax-court.jpg" alt="Studio" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
              ...
              <div class="p-4">
                ...
                <p class="text-gray-300 text-sm mb-4">Modern studio apartment with private bathroom and kitchenette</p>
                <div class="flex gap-2">
                  <button 
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/carfax-court.jpg" alt="One Bed Flat" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
                  £{roomPricing['One Bed Flat'][contractLength]} per week
                </div>
              </div>
              <div class="p-4">
                <h3 class="text-white font-bold text-lg mb-2">One Bed Flat</h3>
                <p class="text-gray-300 text-sm mb-4">Premium one-bedroom apartment with full kitchen and living area</p>
                <div class="flex gap-2">
                  <button 
                    on:click={() => openBookingModal('One Bed Flat')}
                    class="flex-1 bg-njoy-green text-white py-2 px-3 rounded text-sm font-medium hover:bg-green-700 transition-colors"
                  >
                    Book viewing
                  </button>
