<script>
  ...
  // All rooms data for Langdale Courtyard
  const allRooms = [
    { type: 'Standard Ensuite', price51: 142, price45: 154, description: 'Comfortable standard ensuite with modern amenities' },
    { type: 'Large Ensuite', price51: 156, price45: 169, description: 'Spacious ensuite bedroom with enhanced comfort' },
    { type: 'Compact Studio', price51: 168, price45: 182, description: 'Cozy studio apartment with independent living space' },
    { type: 'Ensuite with Private Kitchen', price51: 185, price45: 201, description: 'Premium ensuite with private kitchenette' }
  ];
  ...
  const subLocations = ['Langdale Courtyard'];
...
<svelte:head>
  <title>Langdale Courtyard - All Rooms | Njoy Student Living</title>
  <meta name="description" content="Browse all available rooms at Langdale Courtyard with flexible filtering options" />
</svelte:head>
...
<main class="bg-[#1E1E1E] min-h-screen pt-20">
  ...
  <section style="position: relative; height: 400px; background-image: url('/langdale-courtyard.jpg'); background-size: cover; background-position: center;">
    ...
    <div style="position: absolute; bottom: 40px; left: 40px; color: white;">
      <h1 style="font-size: 3rem; font-weight: 700; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.5);">Langdale Courtyard - All Rooms</h1>
    </div>
  </section>
  `}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {#each filteredRooms as room (room.type)}
                <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
                  <div class="relative">
                    <img src="/langdale-courtyard.jpg" alt={room.type} class="w-full h-48 object-cover">
                  ...
                  <div class="p-4">
                    ...
                    <div class="flex gap-2">
                      ...
                      <a 
                        href="/locations/manchester/langdale-courtyard"
