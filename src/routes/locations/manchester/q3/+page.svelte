<script>
  ...
  const roomPricing = {
    'Double Ensuite': { '51wks': 158, '45wks': 171 },
    'One Bed Flat': { '51wks': 198, '45wks': 215 }
  };
...
<main class="bg-[#1E1E1E] min-h-screen pt-20">
  ...
  {@html `
  <section style="position: relative; height: 400px; background-image: url('/q3-apartments.jpg'); background-size: cover; background-position: center;">
    <!-- Dark overlay -->
    ...
    <div style="position: absolute; bottom: 40px; left: 40px; color: white;">
      <h1 style="font-size: 3rem; font-weight: 700; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.5);">Q3</h1>
    </div>
  </section>
  `}
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-3">
          <div style="background-color: rgb(43, 43, 43);" class="rounded-lg p-6 mb-8">
            <h2 class="text-white font-bold text-2xl mb-4">About Q3</h2>
            <p class="text-gray-300 mb-4">
              Q3 provides contemporary student accommodation in the vibrant heart of Manchester. With modern design and premium amenities, our residents enjoy a sophisticated living experience with excellent connectivity to the city's universities.
            </p>
            <p class="text-gray-300">
              Featuring high-quality finishes and thoughtful design, Q3 offers both ensuite rooms and self-contained apartments to suit different lifestyle preferences.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/q3-apartments.jpg" alt="Double Ensuite" class="w-full h-48 object-cover">
              ...
              <div class="p-4">
                ...
                <p class="text-gray-300 text-sm mb-4">Spacious double room with private ensuite and shared kitchen facilities</p>
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/q3-apartments.jpg" alt="One Bed Flat" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
              ...
              <div class="p-4">
                ...
                <p class="text-gray-300 text-sm mb-4">Self-contained apartment with separate bedroom, kitchen and living area</p>
                <div class="flex gap-2">
...
{#if showBookingModal}
  <BookingModal siteName="Q3" roomType={selectedRoom} bind:isOpen={showBookingModal} />
{/if}
