<script>
  ...
  // All rooms data for Q3
  const allRooms = [
    { type: 'Double Ensuite', price51: 158, price45: 171, description: 'Modern double ensuite bedroom with premium finishes' },
    { type: 'One Bed Flat', price51: 198, price45: 215, description: 'Self-contained one bedroom apartment with full facilities' }
  ];

  const roomTypes = ['Double Ensuite', 'One Bed Flat'];
...
<svelte:head>
  <title>Q3 - All Rooms | Njoy Student Living</title>
  <meta name="description" content="Browse all available rooms at Q3 with flexible filtering options" />
</svelte:head>
...
<main class="bg-[#1E1E1E] min-h-screen pt-20">
  ...
  <section style="position: relative; height: 400px; background-image: url('/q3-apartments.jpg'); background-size: cover; background-position: center;">
    ...
    <div style="position: absolute; bottom: 40px; left: 40px; color: white;">
      <h1 style="font-size: 3rem; font-weight: 700; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.5);">Q3 - All Rooms</h1>
    </div>
  </section>
  `}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {#each filteredRooms as room (room.type)}
                <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
                  <div class="relative">
                    <img src="/q3-apartments.jpg" alt={room.type} class="w-full h-48 object-cover">
