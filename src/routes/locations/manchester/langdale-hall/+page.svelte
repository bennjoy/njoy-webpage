...
<main class="bg-[#1E1E1E] min-h-screen pt-20">
  ...
  {@html `
  <section style="position: relative; height: 400px; background-image: url('/langdale-hall.jpg'); background-size: cover; background-position: center;">
    <!-- Dark overlay -->
    ...
    <div style="position: absolute; bottom: 40px; left: 40px; color: white;">
      <h1 style="font-size: 3rem; font-weight: 700; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.5);">Langdale Hall</h1>
    </div>
  </section>
  `}
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div style="background-color: rgb(43, 43, 43);" class="rounded-lg p-6 sticky top-24">
            ...
            <div class="space-y-3">
              <div class="flex justify-between items-center">
                <span class="text-gray-300">Single Room</span>
                <span class="text-njoy-green font-semibold">£{roomPricing['Single Room'][contractLength]}</span>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-gray-300">Double Room</span>
                <span class="text-njoy-green font-semibold">£{roomPricing['Double Room'][contractLength]}</span>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-gray-300">Large Double</span>
                <span class="text-njoy-green font-semibold">£{roomPricing['Large Double'][contractLength]}</span>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-gray-300">Single Ensuite</span>
                <span class="text-njoy-green font-semibold">£{roomPricing['Single Ensuite'][contractLength]}</span>
              </div>
              <div class="flex justify-between items-center">
        ...
        <div class="lg:col-span-3">
          <div style="background-color: rgb(43, 43, 43);" class="rounded-lg p-6 mb-8">
            <h2 class="text-white font-bold text-2xl mb-4">About Langdale Hall</h2>
            <p class="text-gray-300 mb-4">
              Langdale Hall combines historical charm with contemporary student living in the heart of Manchester's Victoria Park. Our beautifully restored building offers a unique living experience with modern amenities.
            </p>
            <p class="text-gray-300">
              Located in a prestigious area with excellent transport links to Manchester's universities, Langdale Hall provides the perfect balance of tradition and modern student life.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/langdale-hall.jpg" alt="Single Room" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
                  £{roomPricing['Single Room'][contractLength]} per week
                </div>
              </div>
              <div class="p-4">
                <h3 class="text-white font-bold text-lg mb-2">Single Room</h3>
                <p class="text-gray-300 text-sm mb-4">Single bedroom with shared bathroom and communal kitchen</p>
                <div class="flex gap-2">
                  <button 
                    on:click={() => openBookingModal('Single Room')}
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/langdale-hall.jpg" alt="Double Room" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
                  £{roomPricing['Double Room'][contractLength]} per week
                </div>
              </div>
              <div class="p-4">
                <h3 class="text-white font-bold text-lg mb-2">Double Room</h3>
                <p class="text-gray-300 text-sm mb-4">Spacious double bedroom with shared facilities</p>
                <div class="flex gap-2">
                  <button 
                    on:click={() => openBookingModal('Double Room')}
                    class="flex-1 bg-njoy-green text-white py-2 px-3 rounded text-sm font-medium hover:bg-green-700 transition-colors"
                  >
                    Book viewing
                  </button>
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/langdale-hall.jpg" alt="Large Double" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
                  £{roomPricing['Large Double'][contractLength]} per week
                </div>
              </div>
              <div class="p-4">
                <h3 class="text-white font-bold text-lg mb-2">Large Double</h3>
                <p class="text-gray-300 text-sm mb-4">Extra spacious double room with premium furnishings</p>
                <div class="flex gap-2">
                  <button 
                    on:click={() => openBookingModal('Large Double')}
                    class="flex-1 bg-njoy-green text-white py-2 px-3 rounded text-sm font-medium hover:bg-green-700 transition-colors"
                  >
                    Book viewing
                  </button>
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/langdale-hall.jpg" alt="Single Ensuite" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
                  £{roomPricing['Single Ensuite'][contractLength]} per week
                </div>
              </div>
              <div class="p-4">
                <h3 class="text-white font-bold text-lg mb-2">Single Ensuite</h3>
                <p class="text-gray-300 text-sm mb-4">Single room with private ensuite bathroom</p>
                <div class="flex gap-2">
                  <button 
                    on:click={() => openBookingModal('Single Ensuite')}
                    class="flex-1 bg-njoy-green text-white py-2 px-3 rounded text-sm font-medium hover:bg-green-700 transition-colors"
                  >
                    Book viewing
                  </button>
            ...
            <div style="background-color: rgb(43, 43, 43);" class="rounded-lg overflow-hidden">
              <div class="relative">
                <img src="/langdale-hall.jpg" alt="Studio" class="w-full h-48 object-cover">
                <div class="absolute top-3 right-3 bg-njoy-green text-white px-2 py-1 rounded text-sm font-medium">
              ...
              <div class="p-4">
                ...
                <p class="text-gray-300 text-sm mb-4">Self-contained studio apartment with private bathroom and kitchenette</p>
                <div class="flex gap-2">
                  <button 
                    on:click={() => openBookingModal('Studio')}
                    class="flex-1 bg-njoy-green text-white py-2 px-3 rounded text-sm font-medium hover:bg-green-700 transition-colors"
                  >
                    Book viewing
                  </button>
