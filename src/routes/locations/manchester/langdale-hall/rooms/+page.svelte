...
<svelte:head>
  <title>Langdale Hall - All Rooms | Njoy Student Living</title>
  <meta name="description" content="Browse all available rooms at Langdale Hall with flexible filtering options" />
</svelte:head>
...
<main class="bg-[#1E1E1E] min-h-screen pt-20">
  ...
  <section style="position: relative; height: 400px; background-image: url('/langdale-hall.jpg'); background-size: cover; background-position: center;">
    ...
    <div style="position: absolute; bottom: 40px; left: 40px; color: white;">
      <h1 style="font-size: 3rem; font-weight: 700; margin: 0; text-shadow: 0 2px 4px rgba(0,0,0,0.5);">Langdale Hall - All Rooms</h1>
    </div>
  </section>
  `}
